...
----
{isa: [
  {bits: 7,  name: 0b1010111, attr: 'OPFVV'},
  {bits: 5,  name: 'vd', type: 2},
  {bits: 3,  name: 1, attr: 'funct3'},
  {bits: 5,  name: 'vs1', type: 5},
  {bits: 5,  name: 'vs2', type: 2},
  {bits: 1,  name: 'vm'},
  {bits: 6,  name: 0b100010, attr: 'VFUNARY0'},
]}
----
...
{isa: [
  ...
  {bits: 5,  name: 'vs2', type: 2},
  {bits: 1,  name: 'vm'},
  {bits: 6,  name: 0b100011, attr: 'VFUNARY1'},
]}
----
...
{isa: [
  ...
  {bits: 5,  name: 'vs2', type: 2},
  {bits: 1,  name: 'vm'},
  {bits: 6,  name: 0b010110, attr: 'VMUNARY0'},
]}
----
