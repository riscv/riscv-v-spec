...
```wavedrom
{reg: [
  {bits: 7, name: 0b0000111, attr: 'VL* unit-stride'},
...
```wavedrom
{reg: [
  {bits: 7, name: 0b0000111, attr: 'VLS* strided'},
  {bits: 5, name: 'vd', attr: 'destination of load', type: 2},
  {bits: 3, name: 'width'},
  {bits: 5, name: 'rs1', attr: 'base address', type: 4},
...
```wavedrom
{reg: [
  {bits: 7, name: 0b0000111, attr: 'VLX* indexed'},
  {bits: 5, name: 'vd', attr: 'destination of load', type: 2},
  {bits: 3, name: 'width'},
  {bits: 5, name: 'rs1', attr: 'base address', type: 4},
...
```wavedrom
{reg: [
  {bits: 7, name: 0b0100111, attr: 'VS* unit-stride'},
...
```wavedrom
{reg: [
  {bits: 7, name: 0b0100111, attr: 'VSS* strided'},
  {bits: 5, name: 'vs3', attr: 'store data', type: 2},
  {bits: 3, name: 'width'},
  {bits: 5, name: 'rs1', attr: 'base address', type: 4},
  {bits: 5, name: 'rs2', attr: 'stride', type: 4},
...
```wavedrom
{reg: [
  {bits: 7, name: 0b0100111, attr: 'VSX* indexed'},
  {bits: 5, name: 'vs3', attr: 'store data', type: 2},
  {bits: 3, name: 'width'},
  {bits: 5, name: 'rs1', attr: 'base address', type: 4},
  {bits: 5, name: 'vs2', attr: 'address offsets', type: 2},
