...
`vsetvli` and `vsetvl` instructions, and the _first-fault_ vector load
...
with no option to scale, round, and/or saturate the result.
...
(`vmacc`,`vmscc`) and one that overwrites the first multiplicand
(`vmadd`,`vmsub`).
...
# Signed-integer multiply-sub, overwrite minuend
vmscc.vv vd, vs2, vs1, vm    # vd[i] = vd[i] - (vs2[i] * vs1[i])
vmscc.vs vd, vs2, rs1, vm    # vd[i] = vd[i] - (vs2[i] * x[rs1])
...
# Signed-integer multiply-sub, overwrite multiplicand
vmsub.vv vd, vs2, vs1, vm    # vd[i] = vs2[i] - (vd[i] * vs1[i])
vmsub.vs vd, vs2, rs1, vm    # vd[i] = vs2[i] - (vd[i] * x[rs1])
...
# Unsigned-integer multiply-sub, overwrite minuend
vmsccu.vv vd, vs2, vs1, vm    # vd[i] = vd[i] - (vs2[i] * vs1[i])
vmsccu.vs vd, vs2, rs1, vm    # vd[i] = vd[i] - (vs2[i] * x[rs1])
...
# Unsigned-integer multiply-add, overwrite multiplicand
vmsubu.vv vd, vs2, vs1, vm    # vd[i] = vs2[i] - (vd[i] * vs1[i])
vmsubu.vs vd, vs2, rs1, vm    # vd[i] = vs2[i] - (vd[i] * x[rs1])
----
...
vwmacc.vv vd, vs2, vs1, vm    # vd[i] = vd[i] + (vs2[i] * vs1[i])
vwmacc.vs vd, vs2, rs1, vm    # vd[i] = vd[i] + (vs2[i] * x[rs1])

# Widening signed-integer multiply-sub, overwrite minuend
vwmscc.vv vd, vs2, vs1, vm    # vd[i] = vd[i] - (vs2[i] * vs1[i])
vwmscc.vs vd, vs2, rs1, vm    # vd[i] = vd[i] - (vs2[i] * x[rs1])
----
