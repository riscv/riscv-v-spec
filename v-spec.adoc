...
----
    ...
    vlsegff<nf>{b,h,w}.v vd, (rs1),  vm    # Unit-stride signed fault-only-first segment loads
    vlsegff<nf>e.v vd, (rs1),  vm          # Unit-stride fault-only-first segment loads
    vlsegff<nf>{b,h,w}u.v vd, (rs1),   vm  # Unit-stride unsigned fault-only-first segment loads
    vssegff<nf>{b,h,w,e}.v vs3, (rs1), vm  # Unit-stride fault-only-first segment stores
----
