...
----
    ...
    vlseg3b.v vd, (rs1), vm   # Load vector of 3*1-byte segments into vd, vd+1, vd+2
...
[source]
----
vsetvli t0, a0, e32,m1,vdiv4  # Vectors of 32-bit elements, divided into byte sub-elements
...
vsetvli t0, a0, ve32,d4  # Vectors of 32-bit elements, divided into byte sub-elements
