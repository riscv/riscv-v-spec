...
The following table uses a column of LMUL values to represent each
possible constant SEW/LMUL operating point for loops with mixed-width
operations.

[source]
----
       Columns of LMUL values for constant SEW/LMUL
   SEW       
     8   8  4  2  1    
    16      8  4  2  1
    32         8  4  2  1
...
datapath will be active.  The `setvl` instructions below could have a
