...
vsmul.vv vd, vs2, vs1, vm   # Vector-vector
vsmul.vx vd, vs2, rs1, vm   # vector-scalar
----
...
saturating the largest magnitude result but increasing precision by
one bit for all other products when they are reduced back down to N
bits.
