...
An offset is constructed from bits[31:30] for non unit-strided loads
and stores. For unit-strided loads and stores an offset is constructed
from bits[31:30,24:20] and bits[31:30,11:7] respectively.
...
----
 Use of 12b immediate field in vector load/store instruction encoding
  ...
  31 30 29 28 27 26 25 11 10  9  8  7  Store   immediate bits
       funct5    m1 m0   off/str/idx   Field
