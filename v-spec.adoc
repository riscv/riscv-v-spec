...
----
 # Simple reductions.
 vwfredosum.v vd, vs2, vs1, vm # Ordered reduce 2*SEW = sum(SEW) + 2*SEW
 vwfredsum.v vd, vs2, vs1, vm  # Unordered reduce  2*SEW = sum(SEW) + 2*SEW

 # Dot product.
 vwfreddot.v vd, vs2, vs1, vm  # Unordered reduce  2*SEW += sum(SEW*SEW)
----
