...
NOTE: "sac" is intended to invoke "subtract from accumulator".
...
vmsac.vv vd, vs2, vs1, vm    # vd[i] = vd[i] - (vs2[i] * vs1[i])
vmsac.vs vd, vs2, rs1, vm    # vd[i] = vd[i] - (vs2[i] * x[rs1])
...
vmsacu.vv vd, vs2, vs1, vm    # vd[i] = vd[i] - (vs2[i] * vs1[i])
vmsacu.vs vd, vs2, rs1, vm    # vd[i] = vd[i] - (vs2[i] * x[rs1])
...
vwmsac.vv vd, vs2, vs1, vm    # vd[i] = vd[i] - (vs2[i] * vs1[i])
vwmsac.vs vd, vs2, rs1, vm    # vd[i] = vd[i] - (vs2[i] * x[rs1])
----
