...
----
   ...
   {
           enable = m<1> == 0 || m<0> == v1[i]<0>;
           vd[i]<maxew-1..0> = enable ? (vs1[i]<vemaxw-1..0> == sext(imm) ? 1 : 0) : 0;
   }
   for (     ; i < maxvl; i++ )
   {
           vd[i]<maxew-1..0> = 0;
...
----
   for (i = 0; i < maxvl; i++ )
   {
           vd[i]<maxew-1..0> = enable ? (vs1[0]<vemaxw-1..0> == sext(imm) ? 1 : 0): 0;
   }
----
...
----
   ...
   {
           enable = m<1> == 0 || m<0> == v1[i]<0>;
           vd[i]<maxew-1..0> = enable ? (vs1[i]<vemaxw-1..0> <=u sext(imm) ? 1 : 0) : 0;
   }
   for (     ; i < maxvl; i++ )
   {
           vd[i]<maxew-1..0> = 0;
...
----
   for (i = 0; i < maxvl; i++ )
   {
           vd[i]<maxew-1..0> = enable ? (vs1[0]<vemaxw-1..0> <=u sext(imm) ? 1 : 0): 0;
   }
----
